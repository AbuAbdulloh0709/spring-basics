...
public class GiftCertificateDaoImpl implements GiftCertificateDAO {
    ...
    @Autowired
    public GiftCertificateDaoImpl(JdbcTemplate jdbcTemplate, GiftCertificateMapper rowMapper, TagMapper tagMapper) {
    ...
    private void addNewTagsToCertificate(GiftCertificate item) {
        ...
        for (Tag tag : item.getTags()) {
            jdbcTemplate.update(ADD_TAGS_QUERY, item.getId(), tag.getId());
        }
    }
